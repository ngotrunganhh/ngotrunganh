...
class SPAM:
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"|NGOTRUNGANH| NHẬP SỐ ĐIỆN THOẠI CẦN SPAM  : "))
            if self.phone != '0346108060':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0346108060':
                print(self.format_print("!", "SPAM CC SĐT TAO"))
            time.sleep(3)
